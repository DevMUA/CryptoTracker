package com.ESproject.AccountApp.registration;
...
import com.ESproject.AccountApp.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String token = appAccountService.signUpUser(
                new Account(
    ...
    public String confirmToken(String token) {
        ...
        appAccountService.enableAppUser(
